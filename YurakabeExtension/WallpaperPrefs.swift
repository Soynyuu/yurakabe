...
///
/// Thread-safe via `OSAllocatedUnfairLock`. Observes `io.github.soynyuu.yurakabe.prefsChanged`
...
final class WallpaperPrefs: @unchecked Sendable {
    ...
    private static var prefsURL: URL {
        docsURL.appendingPathComponent("yurakabe-prefs.json")
    }

    private static var stateURL: URL {
        docsURL.appendingPathComponent("yurakabe-state.json")
    }
    ...
    var userPaused: Bool {
        lock.withLock { $0.userPaused } || DesktopAppearance.mode == .still
    }

    var alwaysPauseDesktop: Bool {
        DesktopAppearance.mode != .everywhere
    }
    ...
    /// Whether a Yurakabe choice is the active screensaver (relayed by the app from
    ...
    func observeChanges() {
        ...
        CFNotificationCenterAddObserver(
            ...
            "io.github.soynyuu.yurakabe.prefsChanged" as CFString,
            nil,
            .deliverImmediately,
        )
    }
    ...
    func stopObserving() {
        ...
        CFNotificationCenterRemoveObserver(
            center,
            observer,
            CFNotificationName("io.github.soynyuu.yurakabe.prefsChanged" as CFString),
            nil,
        )
    }
    ...
    private func postStateNotification() {
        ...
        CFNotificationCenterPostNotification(
            center,
            CFNotificationName("io.github.soynyuu.yurakabe.stateChanged" as CFString),
            nil,
            nil,
            true,
        )

...
func buildSettingsViewModelsXPC() async -> AnyObject? {
    let bundleID = Bundle.main.bundleIdentifier ?? "io.github.soynyuu.yurakabe.extension"
    ...
    // matching yurakabe:// URL in the companion app.
    ...
    // reinstall or OS update — a cached empty group hides the Yurakabe section
...
/// Yurakabe's own; the system only stores and returns the selected id.
